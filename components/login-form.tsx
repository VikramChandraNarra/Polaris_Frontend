    ...
    <div className={cn("flex flex-col gap-6 w-full", className)} {...props}>
      <Card className="border-slate-800 bg-[#0f1420]">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-slate-400">Login to your Polaris account</CardDescription>
        </CardHeader>
        <CardContent>
          <form>
            <div className="grid gap-6">
                ...
                <div className="grid gap-2">
                  <div className="flex items-center">
                    ...
                    <Link
                      ...
                      className="ml-auto text-sm text-[#5b46f4] underline-offset-4 hover:text-[#7a68ff] hover:underline"
                    >
              ...
              <div className="text-center text-sm text-slate-400">
                ...
                <Link href="/signup" className="text-[#5b46f4] underline-offset-4 hover:text-[#7a68ff] hover:underline">
                  Sign up
                </Link>
              </div>
            </div>
